          ...
          <div className="flex flex-col justify-between">
            <div className="space-y-5">
              ...
              <p>
                ...
                We don't just follow trends; we set them. Our strategic thinking
                ensures your brand stays ahead in the dynamic digital landscape.
              </p>
              <p>
                <strong>Comprehensive Services: </strong>
                From website design to SEO mastery, our services are tailored to
                meet the unique needs of your business, creating a holistic
                digital presence.
              </p>
            </div>
            <div>
